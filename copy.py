...
class Route:
    ...
    def __init__(self,port1,port2,port3,port4,port5,craft='777',genperms=True):  ##genperm can be set to False to turn off the permutations and refactor and use class to be of use in other apps
        ...
        #self.calclegs()
        self.portlist=[self.port1,self.port2,self.port3,self.port4,self.port5,self.port6,self.port7] # a convenience array of airports in submitted route
