...
class Cleanup_candidate_routes():

    def __init__(self,candidates={},craft_range=7000):  ####GET RID OF ROUTES THAT HAVE A LEG GREATER THAN FUEL TANK CAPACITIY or HAVE SAME PORT LISTED TWICE IN SUCCESSION
